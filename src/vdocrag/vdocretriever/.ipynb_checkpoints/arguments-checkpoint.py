...
class DataArguments:
    ...
    dataset_name: str = field(
        default="/home/zhuyinglian/fdu02_dir/zyl/downloads/QA_data_sub5000", metadata={"help": "huggingface dataset name"}
    )
    ...
    corpus_name: str = field(
        default='/home/zhuyinglian/fdu02_dir/zyl/downloads/corpus_data_sub5000', metadata={"help": "huggingface dataset name"}
    )
    ...
    positive_document_no_shuffle: bool = field(
        default=True, metadata={"help": "always use the first positive document for training"})
...
@dataclass
class VDocRetrieverTrainingArguments(TrainingArguments):
